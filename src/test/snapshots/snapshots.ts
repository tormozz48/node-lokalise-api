...
describe(`api/${SCOPE}`, () => {
    ...
    describe('list', async () => {
        it('should receive list of project snapshots', async () => {
            ...
            const result = await localiseAPI.snapshots.list('abcde.12345', {page: 1, limit: 100});
    ...
    describe('create', async () => {
        it('should create project snapshot', async () => {
            ...
            const result = await localiseAPI.snapshots
    ...
    describe('delete', async () => {
        it('should delete project snapshot', async () => {
            ...
            const result = await localiseAPI.snapshots.delete('abcde.12345', 567);
