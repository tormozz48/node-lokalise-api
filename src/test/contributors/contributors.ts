...
describe(`api/${SCOPE}`, () => {
    ...
    describe('list', () => {
        it('should return list of all contributors', async () => {
            ...
            const result = await localiseAPI.contributors.list('abcde.12345', {page: 1, limit: 100});
    ...
    describe('get', () => {
        it('should return single contributor', async () => {
            ...
            const result = await localiseAPI.contributors.get('abcde.12345', 567);
    ...
    describe('create', () => {
        it('should create new contributor', async () => {
            ...
            const result = await localiseAPI.contributors
    ...
    describe('delete', () => {
        it('should remove contributor', async () => {
            ...
            const result = await localiseAPI.contributors.delete('abcde.12345', 567);
